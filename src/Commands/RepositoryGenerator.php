...
class RepositoryGenerator extends Command
{
     ...
     * @var string
     */
    protected $signature = 'gcrud:makerepository
     ...
     * @var string
     */
    protected $description = 'Create repository with a multilayer structure';
    ...
    protected function interactive()
    {
        ...
        $name = ucwords($name);
        $confirmOverwrite = $this->ask("If the file {$name}Repository already exists, do you want it to be overwritten? [Y,n]") ?? 'y';
